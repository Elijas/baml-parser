...
class BamlStreamClient:
    ...
    def ParseCompletion(
        ...
        completion: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[partial_types.Result, types.Result]:
      __tb__ = baml_options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      else:
      ...
      return baml_py.BamlStream[partial_types.Result, types.Result](
        raw,
    ...
    def ParseFood(
        ...
        completion: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[partial_types.Food, types.Food]:
      __tb__ = baml_options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      else:
      ...
      return baml_py.BamlStream[partial_types.Food, types.Food](
        raw,
